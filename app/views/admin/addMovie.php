...
<div class="my-3 my-md-5">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <form action="<?php echo BASE_URL; ?>/admin/addMovie" class="card" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="basic-url" placeholder="120"
                                               name="thoiluong"
                                               value="<?php echo isset($data['thoiluong']) ? $data['thoiluong'] : '' ?>">
                  ...
                  <span class="input-group-text">Phút</span>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="daodien" placeholder="Nguyễn văn tèo"
                                           value="<?php echo isset($data['daodien']) ? $data['daodien'] : '' ?>">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="dienvien"
                                           value="<?php echo isset($data['dienvien']) ? $data['dienvien'] : '' ?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="ngonngu"
                                           value="<?php echo isset($data['ngonngu']) ? $data['ngonngu'] : '' ?>"
                                           class="form-control"/>
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-4">
                  ...
                  <span class="input-group-text">www.youtube.com/embed/=</span>
                                        ...
                                        <input type="text" class="form-control" id="basic-url"
                                               ...
                                               value="<?php echo isset($data['trailer_url']) ? $data['trailer_url'] : '' ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="rated" class="noidung"
                                           ...
                                           value="<?php echo isset($data['rated']) ? $data['rated'] : '' ?>">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="noidung"
                                              rows="16"><?php echo isset($data['noidung']) ? $data['noidung'] : '' ?></textarea>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" name="photo"
                                               value="<?php echo isset($data['photo']) ? $data['photo'] : '' ?>">
